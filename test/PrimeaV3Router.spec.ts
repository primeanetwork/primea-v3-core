...
describe('PrimeaV3Pool', () => {
  ...
  let pool0: MockTimePrimeaV3Pool
  let pool1: MockTimePrimeaV3Pool
  ...
  let swapTargetCallee: TestPrimeaV3Callee
  let swapTargetRouter: TestPrimeaV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimePrimeaV3Pool, any]> => {
