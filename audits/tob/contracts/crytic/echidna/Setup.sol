...
import '../../../../../contracts/PrimeaV3Factory.sol';
...
contract SetupTokens {
    ...
    constructor() public {
        ...
        // mimics Primea V3 factory behavior based on Uniswap architecture
...
contract SetupPrimea {
    PrimeaV3Pool public pool;
    TestERC20 token0;
    TestERC20 token1;
    ...
    PrimeaV3Factory factory;

    constructor(TestERC20 _token0, TestERC20 _token1) public {
        factory = new PrimeaV3Factory();
        token0 = _token0;
        token1 = _token1;
    }

    function createPool(uint24 _fee, uint160 _startPrice) public {
        pool = PrimeaV3Pool(factory.createPool(address(token0), address(token1), _fee));
        pool.initialize(_startPrice);
    }
}

contract PrimeaMinter {
    PrimeaV3Pool pool;
    TestERC20 token0;
    TestERC20 token1;
    ...
    function setPool(PrimeaV3Pool _pool) public {
        pool = _pool;
    }
